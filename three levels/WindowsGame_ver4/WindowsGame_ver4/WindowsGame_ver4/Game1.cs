...
using WindowsGame_ver2;

namespace WindowsGame_ver4
{    
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Texture2D[] mySpriteTexture = new Texture2D[7]; //魚
        Point[] mySpritePos = new Point[7];
        Vector2 vect;
        bool[] flag = new bool[7]; //有無進魚缸
        ...
        double[] myThetaList = new double[7];//上下起伏效果
        /******************************************************************************************/
        double G = 1; 		// 重力
        int V = 40; 		// 移動速度
        ...
        public void jump(MouseState mouseState, GameTime gameTime) // 拋物線
        {
            ...
            else
            {
                if (!dragging)
                {
                    ...
                    if (Collides(mySpritePos[drag_Num]))//碰到魚缸
                    {
                        //Console.WriteLine("!!!!!!!!!!!!!!!!!!!!!!!");
